import{S as f,A as I,a as B,N as P,K as N,i as O}from"./assets/vendor-fc10b007.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function o(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=o(s);fetch(s.href,n)}})();document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(".modal-header"),t=document.querySelector(".modal-btn-close"),o=document.querySelector(".header-icon-burger"),i=document.querySelectorAll(".menu-list a"),s=document.querySelector(".btn-menu-tablet"),n=document.querySelector(".btn-menu"),l=document.querySelector(".menu-center-open"),b=document.querySelector(".menu-center-list");function C(){e.classList.add("is-open"),document.body.style.overflow="hidden",t.style.display="flex"}function u(){e.classList.remove("is-open"),document.body.style.overflow=""}t.addEventListener("click",u),o.addEventListener("click",C),s.addEventListener("click",u),n.addEventListener("click",u),i.forEach(function(g){g.addEventListener("click",function($){u()})}),document.querySelectorAll(".menu-center-item a").forEach(function(g){g.addEventListener("click",function($){b.classList.remove("is-open")})}),l.addEventListener("click",function(){b.classList.toggle("is-open")})});const T=document.querySelectorAll(".aboutus-accordion-item");document.addEventListener("DOMContentLoaded",function(){T.forEach(function(t,o){const i=t.querySelector(".aboutus-accord-dropdown"),s=t.querySelector(".aboutus-accord-btn-down"),n=t.querySelector(".aboutus-accord-btn-up");o===0&&(i.classList.toggle("hidden"),i.classList.add("active"),s.classList.add("hidden"),n.classList.remove("hidden")),n.addEventListener("mouseenter",function(){titleAccordion.classList.add("hovered")}),n.addEventListener("mouseleave",function(){titleAccordion.classList.remove("hovered")}),s.addEventListener("mouseenter",function(){titleAccordion.classList.add("hovered")}),s.addEventListener("mouseleave",function(){titleAccordion.classList.remove("hovered")}),s.addEventListener("click",function(){e(t)}),n.addEventListener("click",function(){e(t)})});function e(t){const o=t.querySelector(".aboutus-accord-dropdown"),i=t.querySelector(".aboutus-accord-btn-down"),s=t.querySelector(".aboutus-accord-btn-up");o.classList.toggle("active"),o.classList.toggle("hidden"),s.classList.toggle("hidden"),i.classList.toggle("hidden"),o.classList.contains("active")?o.style.maxHeight=o.scrollHeight+"px":o.style.maxHeight="0"}});document.addEventListener("DOMContentLoaded",function(){const e=document.querySelectorAll(".aboutus-skills-circle"),t=document.querySelector(".swiper-wrapper");e.forEach((s,n)=>{const l=s.cloneNode(!0);t.appendChild(l)});const o=new f(".aboutus-skills-swiper",{speed:400,spaceBetween:0,loop:!0,setWrapperSize:!0,breakpoints:{1440:{slidesPerView:6},768:{slidesPerView:3},320:{slidesPerView:2}},on:{init:function(){document.querySelector(".swiper-slide").style.backgroundColor="#ed3b44"},slideChange:function(){const s=this.slides[this.previousIndex],n=this.slides[this.activeIndex];s.style.background="",n.style.backgroundColor="#ed3b44"}}});document.querySelector(".aboutus-skills-btn").addEventListener("click",()=>{o.slideNext()})});const z="/lloyd-jefferson-/assets/img_1_320-bb988309.png",R="/lloyd-jefferson-/assets/img_1_375-111ca135.png",w="/lloyd-jefferson-/assets/img_1_768-daf377c0.png",V="/lloyd-jefferson-/assets/img_1_1440-6e1e77a8.png",D="/lloyd-jefferson-/assets/img_2_320-9880dbfd.png",H="/lloyd-jefferson-/assets/img_2_375-eb6c78ab.png",y="/lloyd-jefferson-/assets/img_2_768-0ceb49a4.png",G="/lloyd-jefferson-/assets/img_2_1440-1fb0ec3f.png",U="/lloyd-jefferson-/assets/img_3_320-82c7ad1f.png",K="/lloyd-jefferson-/assets/img_3_375-356430ed.png",h="/lloyd-jefferson-/assets/img_3_768-6322b368.png",W="/lloyd-jefferson-/assets/img_3_1440-e3ae8908.png",F=document.querySelector(".projects-slider-btn--right"),Z=document.querySelector(".projects-slider-btn--left"),x=new f(".projects-box",{speed:400,spaceBetween:100});Z.addEventListener("click",()=>{Y(),x.slidePrev()});F.addEventListener("click",()=>{Q(),x.slideNext()});const J=document.querySelector(".projects-wrapper"),X=`
  ...
  <li class="swiper-slide projects-slide" id="2">
    <div class="projects-description-box">
        ...
        >
          ...
          <img
            class="projects-image"
            srcset="${D} 292w, ${H} 584w, ${y} 528w, ${G} 1056w"
            sizes="(min-width: 1280px) 580px, (min-width: 768px) 580px, 320px"
            src="${y}"
            alt="Pet Love App"
          />
  ...
  <li class="swiper-slide projects-slide" id=3>
   <div class="projects-description-box">
    ...
    <img class="projects-image" 
      srcset="${U} 292w, ${K} 584w, ${h} 528w, ${W} 1056w"
      sizes="(min-width: 1280px) 580px, (min-width: 768px) 580px, 320px"
      src="${h}"
