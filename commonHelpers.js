import{A as M,S as b,a as V,N as R,K as T,i as p,v as k}from"./assets/vendor-cc0b5173.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function o(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=o(s);fetch(s.href,n)}})();const z=document.querySelector(".loader");document.addEventListener("DOMContentLoaded",()=>{z.style.display="none"});document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(".modal-header"),t=document.querySelector(".modal-btn-close"),o=document.querySelector(".header-icon-burger"),i=document.querySelectorAll(".menu-list a"),s=document.querySelector(".btn-menu-tablet"),n=document.querySelector(".btn-menu"),l=document.querySelector(".menu-center-open"),L=document.querySelector(".menu-center-list");function N(){e.classList.add("is-open"),document.body.style.overflow="hidden",t.style.display="flex"}function m(){e.classList.remove("is-open"),document.body.style.overflow=""}t.addEventListener("click",m),o.addEventListener("click",N),s.addEventListener("click",m),n.addEventListener("click",m),i.forEach(function(v){v.addEventListener("click",function(O){m()})}),document.querySelectorAll(".menu-center-item a").forEach(function(v){v.addEventListener("click",function(O){L.classList.remove("is-open")})}),l.addEventListener("click",function(){L.classList.toggle("is-open")})});new M(".accordion-container-first",{duration:600,showMultiple:!0,openOnInit:[0]});const D=document.querySelectorAll(".aboutus-accordion-item");D.forEach(function(e){const t=e.querySelector(".aboutus-title-accordion"),o=e.querySelector(".aboutus-accord-btn-down");o.addEventListener("mouseenter",function(){t.classList.add("hovered")}),o.addEventListener("mouseleave",function(){t.classList.remove("hovered")})});document.addEventListener("DOMContentLoaded",function(){const e=document.querySelectorAll(".aboutus-skills-circle"),t=document.querySelector(".swiper-wrapper");e.forEach((s,n)=>{const l=s.cloneNode(!0);t.appendChild(l)});const o=new b(".aboutus-skills-swiper",{speed:400,spaceBetween:0,loop:!0,setWrapperSize:!0,breakpoints:{1440:{slidesPerView:6},768:{slidesPerView:3},320:{slidesPerView:2}},on:{init:function(){document.querySelector(".swiper-slide").style.backgroundColor="#ed3b44"},slideChange:function(){const s=this.slides[this.previousIndex],n=this.slides[this.activeIndex];s.style.background="",n.style.backgroundColor="#ed3b44"}}});document.querySelector(".aboutus-skills-btn").addEventListener("click",()=>{o.slideNext()})});const W="/lloyd-jefferson-/assets/img_1_320-bb988309.png",F="/lloyd-jefferson-/assets/img_1_375-111ca135.png",j="/lloyd-jefferson-/assets/img_1_768-daf377c0.png",G="/lloyd-jefferson-/assets/img_1_1440-6e1e77a8.png",H="/lloyd-jefferson-/assets/img_2_320-9880dbfd.png",K="/lloyd-jefferson-/assets/img_2_375-eb6c78ab.png",E="/lloyd-jefferson-/assets/img_2_768-0ceb49a4.png",U="/lloyd-jefferson-/assets/img_2_1440-1fb0ec3f.png",J="/lloyd-jefferson-/assets/img_3_320-82c7ad1f.png",Q="/lloyd-jefferson-/assets/img_3_375-356430ed.png",S="/lloyd-jefferson-/assets/img_3_768-6322b368.png",X="/lloyd-jefferson-/assets/img_3_1440-e3ae8908.png",Y=document.querySelector(".projects-slider-btn--right"),Z=document.querySelector(".projects-slider-btn--left"),C=new b(".projects-box",{speed:400,spaceBetween:100});Z.addEventListener("click",()=>{oe(),C.slidePrev()});Y.addEventListener("click",()=>{se(),C.slideNext()});const ee=document.querySelector(".projects-wrapper"),te=`
  <li class="swiper-slide projects-slide" id=1>
    ...
    <img
      ...
      srcset="${W} 292w, ${F} 584w, ${j} 528w, ${G} 1056w"
  ...
  <li class="swiper-slide projects-slide" id=3>
   <div class="projects-description-box">
    ...
    />
      ...
      </li>`).join("");me.innerHTML=t},_=(e="Not found")=>{const t=document.createElement("p");t.textContent=e,pe.insertAdjacentElement("afterbegin",t)};ge();new b(".reviews-swiper",{modules:[R,T],speed:800,grabCursor:!0,allowTouchMove:!0,direction:"horizontal",watchOverflow:!0,spaceBetween:16,navigation:{nextEl:".next-review-btn",prevEl:".prev-review-btn"},keyboard:{enabled:!0,onlyInViewport:!0,pageUpDown:!0},breakpoints:{320:{slidesPerGroup:1,slidesPerView:1},768:{slidesPerGroup:2,slidesPerView:2},1440:{slidesPerGroup:4,slidesPerView:4}}});p.settings({position:"bottomRight"});const I=document.getElementById("footer-form"),w=document.getElementById("footer-form-input"),y=document.getElementById("footer-form-textarea"),r=document.querySelector(".email-message"),c=document.querySelector(".comment-message"),u=document.querySelector(".footer-form-res"),d=document.getElementById("modal"),ve=document.querySelector(".footer-modal-btn-close"),B=e=>{k.isEmail(e)!==!1?(r.textContent="Success!",r.classList.remove("isErrorMessage"),r.classList.add("isSuccessMessage")):(r.textContent="Invalid email, try again",r.classList.remove("isSuccessMessage"),r.classList.add("isErrorMessage"))},P=e=>{e.trim().length>0?(c.textContent="Success!",c.classList.remove("isErrorMessage"),c.classList.add("isSuccessMessage")):(c.textContent="Please, write some text",c.classList.remove("isSuccessMessage"),c.classList.add("isErrorMessage"))},$=()=>{r.textContent="",c.textContent="",r.classList.remove("isSuccessMessage","isErrorMessage"),c.classList.remove("isSuccessMessage","isErrorMessage")},q=e=>{d.classList.add("show-modal");const[t]=d.getElementsByTagName("h2"),[o]=d.getElementsByTagName("p");t.textContent=e.title,o.textContent=e.message},h=()=>{d.classList.remove("show-modal")},be=e=>{const t=e.target.value;B(t),u.style.display="block"},we=e=>{const t=e.target.value;P(t),u.style.display="block"},ye=async e=>{e.preventDefault();const t={email:w.value,comment:y.value};if(k.isEmail(t.email)===!1){p.error({title:t.email.length<1?"Please, write your email":"Not validate email"}),B(t.email);return}if(t.comment.trim().length<1){p.error({title:"Write some text"}),P(t.comment);return}try{const o=await ue(t);q(o)}catch(o){q({title:"Error",message:o.message})}I.reset(),u.style.display="none",$()},he=()=>{u.style.display="none",w.value="",y.value="",$()};w.addEventListener("input",be);y.addEventListener("input",we);I.addEventListener("submit",ye);u.addEventListener("click",he);ve.addEventListener("click",()=>{h()});window.addEventListener("click",e=>{e.target===d&&h()});window.addEventListener("keydown",e=>{e.key==="Escape"&&h()});
